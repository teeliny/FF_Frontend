  ...
  return (
    <Layout title="Marketing AR - Scan">
      ...
      <div className='relative flex h-screen overflow-hidden reality-background' style={{ backgroundImage: "url('/images/svg/reality-four.svg'), url('/images/svg/reality-two.svg')", minHeight: `${showReady ? '115%' : '100%'}` }}>
        {showReady && (
          <div className='bg-[#0A3085] w-[90%] m-auto px-5 pt-8'>
            ...
            <Image className='w-full ml-5' src='/images/svg/scan-illustration.svg' alt='' width={100} height={10} />
            <div className='flex w-full -mt-4'>
              <button 
                className='bg-yellow-300 w-fit mx-auto px-12 text-[#0A3085] uppercase py-3 text-2xl mb-8' 
                type='submit' 
